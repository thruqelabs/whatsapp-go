...
func (AIThreadInfo_AIThreadClientInfo_AIThreadType) EnumDescriptor() ([]byte, []int) {
	return file_waBotMetadata_WABotMetadata_proto_rawDescGZIP(), []int{0, 0, 0}
}
...
func (BotModeSelectionMetadata_BotUserSelectionMode) EnumDescriptor() ([]byte, []int) {
	return file_waBotMetadata_WABotMetadata_proto_rawDescGZIP(), []int{15, 0}
}
...
func (BotModelMetadata_PremiumModelStatus) EnumDescriptor() ([]byte, []int) {
	return file_waBotMetadata_WABotMetadata_proto_rawDescGZIP(), []int{16, 0}
}
...
func (BotModelMetadata_ModelType) EnumDescriptor() ([]byte, []int) {
	return file_waBotMetadata_WABotMetadata_proto_rawDescGZIP(), []int{16, 1}
}
...
func (BotPluginMetadata_PluginType) EnumDescriptor() ([]byte, []int) {
	return file_waBotMetadata_WABotMetadata_proto_rawDescGZIP(), []int{17, 0}
}
...
func (BotPluginMetadata_SearchProvider) EnumDescriptor() ([]byte, []int) {
	return file_waBotMetadata_WABotMetadata_proto_rawDescGZIP(), []int{17, 1}
}
...
func (BotProgressIndicatorMetadata_BotPlanningStepMetadata_BotSearchSourceProvider) EnumDescriptor() ([]byte, []int) {
	return file_waBotMetadata_WABotMetadata_proto_rawDescGZIP(), []int{18, 0, 0}
}
...
func (BotProgressIndicatorMetadata_BotPlanningStepMetadata_PlanningStepStatus) EnumDescriptor() ([]byte, []int) {
	return file_waBotMetadata_WABotMetadata_proto_rawDescGZIP(), []int{18, 0, 1}
}
...
func (BotProgressIndicatorMetadata_BotPlanningStepMetadata_BotPlanningSearchSourcesMetadata_BotPlanningSearchSourceProvider) EnumDescriptor() ([]byte, []int) {
	return file_waBotMetadata_WABotMetadata_proto_rawDescGZIP(), []int{18, 0, 0, 0}
}
...
func (BotPromotionMessageMetadata_BotPromotionType) EnumDescriptor() ([]byte, []int) {
	return file_waBotMetadata_WABotMetadata_proto_rawDescGZIP(), []int{19, 0}
}
...
func (BotQuotaMetadata_BotFeatureQuotaMetadata_BotFeatureType) EnumDescriptor() ([]byte, []int) {
	return file_waBotMetadata_WABotMetadata_proto_rawDescGZIP(), []int{22, 0, 0}
}
...
func (BotReminderMetadata_ReminderAction) EnumDescriptor() ([]byte, []int) {
	return file_waBotMetadata_WABotMetadata_proto_rawDescGZIP(), []int{23, 1}
}
...
func (BotSourcesMetadata_BotSourceItem_SourceProvider) Descriptor() protoreflect.EnumDescriptor {
	return file_waBotMetadata_WABotMetadata_proto_enumTypes[23].Descriptor()
}

func (BotSourcesMetadata_BotSourceItem_SourceProvider) Type() protoreflect.EnumType {
	return &file_waBotMetadata_WABotMetadata_proto_enumTypes[23]
}
...
func (BotSourcesMetadata_BotSourceItem_SourceProvider) EnumDescriptor() ([]byte, []int) {
	return file_waBotMetadata_WABotMetadata_proto_rawDescGZIP(), []int{28, 0, 0}
}
...
type BotAgeCollectionMetadata struct {
	...
	AgeCollectionType                  *BotAgeCollectionMetadata_AgeCollectionType `protobuf:"varint,3,opt,name=ageCollectionType,enum=WABotMetadata.BotAgeCollectionMetadata_AgeCollectionType" json:"ageCollectionType,omitempty"`
	unknownFields                      protoimpl.UnknownFields
	sizeCache                          protoimpl.SizeCache
}
...
type BotMetadata struct {
	...
	RegenerateMetadata           *waAICommon.AIRegenerateMetadata         `protobuf:"bytes,32,opt,name=regenerateMetadata" json:"regenerateMetadata,omitempty"`
	SessionTransparencyMetadata  *waAICommon.SessionTransparencyMetadata  `protobuf:"bytes,33,opt,name=sessionTransparencyMetadata" json:"sessionTransparencyMetadata,omitempty"`
	BotDocumentMessageMetadata   *waAICommon.BotDocumentMessageMetadata   `protobuf:"bytes,34,opt,name=botDocumentMessageMetadata" json:"botDocumentMessageMetadata,omitempty"`
	BotGroupMetadata             *waAICommon.BotGroupMetadata             `protobuf:"bytes,35,opt,name=botGroupMetadata" json:"botGroupMetadata,omitempty"`
	BotRenderingConfigMetadata   *waAICommon.BotRenderingConfigMetadata   `protobuf:"bytes,36,opt,name=botRenderingConfigMetadata" json:"botRenderingConfigMetadata,omitempty"`
	BotInfrastructureDiagnostics *waAICommon.BotInfrastructureDiagnostics `protobuf:"bytes,37,opt,name=botInfrastructureDiagnostics" json:"botInfrastructureDiagnostics,omitempty"`
	AiMediaCollectionMetadata    *waAICommon.AIMediaCollectionMetadata    `protobuf:"bytes,38,opt,name=aiMediaCollectionMetadata" json:"aiMediaCollectionMetadata,omitempty"`
	CommandMetadata              *waAICommon.BotCommandMetadata           `protobuf:"bytes,39,opt,name=commandMetadata" json:"commandMetadata,omitempty"`
	ResolvedToolCallMetadata     *waAICommon.BotResolvedToolCallMetadata  `protobuf:"bytes,40,opt,name=resolvedToolCallMetadata" json:"resolvedToolCallMetadata,omitempty"`
	SubscriptionUpsellMetadata   *waAICommon.AISubscriptionUpsellMetadata `protobuf:"bytes,41,opt,name=subscriptionUpsellMetadata" json:"subscriptionUpsellMetadata,omitempty"`
	PttPromptMetadata            *waAICommon.BotPttPromptMetadata         `protobuf:"bytes,42,opt,name=pttPromptMetadata" json:"pttPromptMetadata,omitempty"`
	BotHistoryShareMetadata      *waAICommon.BotHistoryShareMetadata      `protobuf:"bytes,43,opt,name=botHistoryShareMetadata" json:"botHistoryShareMetadata,omitempty"`
...
func (x *BotMetadata) GetRegenerateMetadata() *waAICommon.AIRegenerateMetadata {
	if x != nil {
...
func (x *BotMetadata) GetSessionTransparencyMetadata() *waAICommon.SessionTransparencyMetadata {
	if x != nil {
...
func (x *BotMetadata) GetBotDocumentMessageMetadata() *waAICommon.BotDocumentMessageMetadata {
	if x != nil {
...
func (x *BotMetadata) GetBotGroupMetadata() *waAICommon.BotGroupMetadata {
	if x != nil {
...
func (x *BotMetadata) GetBotRenderingConfigMetadata() *waAICommon.BotRenderingConfigMetadata {
	if x != nil {
...
func (x *BotMetadata) GetBotInfrastructureDiagnostics() *waAICommon.BotInfrastructureDiagnostics {
	if x != nil {
...
func (x *BotMetadata) GetAiMediaCollectionMetadata() *waAICommon.AIMediaCollectionMetadata {
	if x != nil {
...
func (x *BotMetadata) GetCommandMetadata() *waAICommon.BotCommandMetadata {
	if x != nil {
...
func (x *BotMetadata) GetResolvedToolCallMetadata() *waAICommon.BotResolvedToolCallMetadata {
	if x != nil {
...
func (x *BotMetadata) GetSubscriptionUpsellMetadata() *waAICommon.AISubscriptionUpsellMetadata {
	if x != nil {
...
func (x *BotMetadata) GetPttPromptMetadata() *waAICommon.BotPttPromptMetadata {
	if x != nil {
...
func (x *BotMetadata) GetBotHistoryShareMetadata() *waAICommon.BotHistoryShareMetadata {
	if x != nil {
...
func (*BotProgressIndicatorMetadata_BotPlanningStepMetadata) Descriptor() ([]byte, []int) {
	return file_waBotMetadata_WABotMetadata_proto_rawDescGZIP(), []int{18, 0}
}
...
func (*BotProgressIndicatorMetadata_BotPlanningStepMetadata_BotPlanningSearchSourceMetadata) Descriptor() ([]byte, []int) {
	return file_waBotMetadata_WABotMetadata_proto_rawDescGZIP(), []int{18, 0, 2}
}
...
func (*BotRenderingMetadata_Keyword) Descriptor() ([]byte, []int) {
	return file_waBotMetadata_WABotMetadata_proto_rawDescGZIP(), []int{24, 0}
}
...
type BotSignatureVerificationUseCaseProof_CertificateSKI struct {
	state         protoimpl.MessageState                                    `protogen:"open.v1"`
	UseCase       *BotSignatureVerificationUseCaseProof_BotSignatureUseCase `protobuf:"varint,1,opt,name=useCase,enum=WABotMetadata.BotSignatureVerificationUseCaseProof_BotSignatureUseCase" json:"useCase,omitempty"`
...
func (*InThreadSurveyMetadata_InThreadSurveyPrivacyStatementPart) Descriptor() ([]byte, []int) {
	return file_waBotMetadata_WABotMetadata_proto_rawDescGZIP(), []int{31, 0}
}
...
func (*InThreadSurveyMetadata_InThreadSurveyOption) Descriptor() ([]byte, []int) {
	return file_waBotMetadata_WABotMetadata_proto_rawDescGZIP(), []int{31, 1}
}
...
func (x *InThreadSurveyMetadata_InThreadSurveyQuestion) Reset() {
	*x = InThreadSurveyMetadata_InThreadSurveyQuestion{}
	mi := &file_waBotMetadata_WABotMetadata_proto_msgTypes[46]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*InThreadSurveyMetadata_InThreadSurveyQuestion) Descriptor() ([]byte, []int) {
	return file_waBotMetadata_WABotMetadata_proto_rawDescGZIP(), []int{31, 2}
}
...
const file_waBotMetadata_WABotMetadata_proto_rawDesc = "" +
	...
	"\"shouldTriggerAgeCollectionOnClient\x18\x02 \x01(\bR\"shouldTriggerAgeCollectionOnClient\x12g\n" +
	"\x11ageCollectionType\x18\x03 \x01(\x0e29.WABotMetadata.BotAgeCollectionMetadata.AgeCollectionTypeR\x11ageCollectionType\"/\n" +
	"\x11AgeCollectionType\x12\x0e\n" +
	"\n" +
	"O18_BINARY\x10\x00\x12\n" +
	"\n" +
	"\x06WAFFLE\x10\x01\"\xab\x01\n" +
	...
	"\x1aBOT_LINKED_ACCOUNT_TYPE_1P\x10\x00\"\x9e\x01\n" +
	...
	"\vacErrorCode\x18\x03 \x01(\x05R\vacErrorCode\"\xed\x02\n" +
	...
	"\x06factID\x18\x02 \x01(\tR\x06factID\"\xb3\x01\n" +
	...
	"$BOT_MESSAGE_ORIGIN_TYPE_AI_INITIATED\x10\x00\"U\n" +
	"\x18BotMessageOriginMetadata\x129\n" +
	"\aorigins\x18\x01 \x03(\v2\x1f.WABotMetadata.BotMessageOriginR\aorigins\"\xe2\x1d\n" +
	"\vBotMetadata\x12H\n" +
	...
	"\x10internalMetadata\x18\xe7\a \x01(\fR\x10internalMetadata\x12\\\n" +
	...
	"\x15responseStoppedByUser\x18, \x01(\bR\x15responseStoppedByUser\"\xe4\x01\n" +
	...
	"\fthreadOrigin\x18\x03 \x01(\x0e2).WABotMetadata.BotMetricsThreadEntryPointR\fthreadOrigin\"\xce\x01\n" +
	"\x18BotModeSelectionMetadata\x12P\n" +
	"\x04mode\x18\x01 \x03(\x0e2<.WABotMetadata.BotModeSelectionMetadata.BotUserSelectionModeR\x04mode\x12\"\n" +
	"\foverrideMode\x18\x02 \x03(\rR\foverrideMode\"<\n" +
	"\x14BotUserSelectionMode\x12\x10\n" +
	"\fUNKNOWN_MODE\x10\x00\x12\x12\n" +
	"\x0eREASONING_MODE\x10\x01\"\x85\x03\n" +
	"\x10BotModelMetadata\x12G\n" +
	"\tmodelType\x18\x01 \x01(\x0e2).WABotMetadata.BotModelMetadata.ModelTypeR\tmodelType\x12b\n" +
	"\x12premiumModelStatus\x18\x02 \x01(\x0e22.WABotMetadata.BotModelMetadata.PremiumModelStatusR\x12premiumModelStatus\x12,\n" +
	...
	"\x12LLAMA_PROD_PREMIUM\x10\x02\"\xce\x06\n" +
	...
	"\aSUPPORT\x10\x03\"\x85\x0e\n" +
	"\x1cBotProgressIndicatorMetadata\x120\n" +
	"\x13progressDescription\x18\x01 \x01(\tR\x13progressDescription\x12i\n" +
	"\rstepsMetadata\x18\x02 \x03(\v2C.WABotMetadata.BotProgressIndicatorMetadata.BotPlanningStepMetadataR\rstepsMetadata\x128\n" +
	"\x17estimatedCompletionTime\x18\x03 \x01(\x03R\x17estimatedCompletionTime\x1a\x8d\f\n" +
	...
	"\bpromptID\x18\x02 \x01(\tR\bpromptID\"\\\n" +
	"\x14BotPromptSuggestions\x12D\n" +
	"\vsuggestions\x18\x01 \x03(\v2\".WABotMetadata.BotPromptSuggestionR\vsuggestions\"\xa3\x03\n" +
	...
	"\x11REASONING_FEATURE\x10\x01\"\xd3\x03\n" +
	...
	"\rsessionSource\x18\x02 \x01(\x0e2\x1f.WABotMetadata.BotSessionSourceR\rsessionSource\"o\n" +
	" BotSignatureVerificationMetadata\x12K\n" +
	"\x06proofs\x18\x01 \x03(\v23.WABotMetadata.BotSignatureVerificationUseCaseProofR\x06proofs\"\xe9\x04\n" +
	...
	"\x10certificateChain\x18\x04 \x01(\fR\x10certificateChain\x12t\n" +
	"\x13certificateChainSki\x18\x05 \x03(\v2B.WABotMetadata.BotSignatureVerificationUseCaseProof.CertificateSKIR\x13certificateChainSki\x1a\x85\x01\n" +
	"\x0eCertificateSKI\x12a\n" +
	"\auseCase\x18\x01 \x01(\x0e2G.WABotMetadata.BotSignatureVerificationUseCaseProof.BotSignatureUseCaseR\auseCase\x12\x10\n" +
	...
	"\x0eWA_FEATURE_PKI\x10\x05\"\x84\x04\n" +
	...
	"\x10selectedPromptID\x18\x04 \x01(\tR\x10selectedPromptID\"\xa3\x04\n" +
	...
	"\fpreviewMedia\x18\x03 \x01(\v2\x1f.WABotMetadata.BotMediaMetadataR\fpreviewMedia\x1av\n" +
	"\x12SideBySideMetadata\x12,\n" +
	"\x11primaryResponseID\x18\x01 \x01(\tR\x11primaryResponseID\x122\n" +
	"\x14surveyCtaHasRendered\x18\x02 \x01(\bR\x14surveyCtaHasRendered\"\xc8\n" +
	"\n" +
	...
	"questionID\x12d\n" +
	"\x0fquestionOptions\x18\x03 \x03(\v2:.WABotMetadata.InThreadSurveyMetadata.InThreadSurveyOptionR\x0fquestionOptions*\xbb\n" +
	"\n" +
	...
	"\x13NEW_CHAT_AI_CONTACT\x10 \x12\x19\n" +
	"\x15UNDEFINED_ENTRY_POINT\x10\x00\x12$\n" +
	...
	"\x0fAI_HOME_SESSION\x10\aB)Z'go.mau.fi/whatsmeow/proto/waBotMetadata"
...
var file_waBotMetadata_WABotMetadata_proto_enumTypes = make([]protoimpl.EnumInfo, 24)
var file_waBotMetadata_WABotMetadata_proto_msgTypes = make([]protoimpl.MessageInfo, 47)
var file_waBotMetadata_WABotMetadata_proto_goTypes = []any{
	...
	(AIThreadInfo_AIThreadClientInfo_AIThreadType)(0),                                 // 3: WABotMetadata.AIThreadInfo.AIThreadClientInfo.AIThreadType
	(BotAgeCollectionMetadata_AgeCollectionType)(0),                                   // 4: WABotMetadata.BotAgeCollectionMetadata.AgeCollectionType
	(BotCapabilityMetadata_BotCapabilityType)(0),                                      // 5: WABotMetadata.BotCapabilityMetadata.BotCapabilityType
	(BotImagineMetadata_ImagineType)(0),                                               // 6: WABotMetadata.BotImagineMetadata.ImagineType
	(BotLinkedAccount_BotLinkedAccountType)(0),                                        // 7: WABotMetadata.BotLinkedAccount.BotLinkedAccountType
	(BotMediaMetadata_OrientationType)(0),                                             // 8: WABotMetadata.BotMediaMetadata.OrientationType
	(BotMessageOrigin_BotMessageOriginType)(0),                                        // 9: WABotMetadata.BotMessageOrigin.BotMessageOriginType
	(BotModeSelectionMetadata_BotUserSelectionMode)(0),                                // 10: WABotMetadata.BotModeSelectionMetadata.BotUserSelectionMode
	...
	(BotPluginMetadata_PluginType)(0),                                                 // 13: WABotMetadata.BotPluginMetadata.PluginType
	(BotPluginMetadata_SearchProvider)(0),                                             // 14: WABotMetadata.BotPluginMetadata.SearchProvider
	(BotProgressIndicatorMetadata_BotPlanningStepMetadata_BotSearchSourceProvider)(0), // 15: WABotMetadata.BotProgressIndicatorMetadata.BotPlanningStepMetadata.BotSearchSourceProvider
	(BotProgressIndicatorMetadata_BotPlanningStepMetadata_PlanningStepStatus)(0),      // 16: WABotMetadata.BotProgressIndicatorMetadata.BotPlanningStepMetadata.PlanningStepStatus
	(BotProgressIndicatorMetadata_BotPlanningStepMetadata_BotPlanningSearchSourcesMetadata_BotPlanningSearchSourceProvider)(0), // 17: WABotMetadata.BotProgressIndicatorMetadata.BotPlanningStepMetadata.BotPlanningSearchSourcesMetadata.BotPlanningSearchSourceProvider
	(BotPromotionMessageMetadata_BotPromotionType)(0),                                                                          // 18: WABotMetadata.BotPromotionMessageMetadata.BotPromotionType
	(BotQuotaMetadata_BotFeatureQuotaMetadata_BotFeatureType)(0),                                                               // 19: WABotMetadata.BotQuotaMetadata.BotFeatureQuotaMetadata.BotFeatureType
	(BotReminderMetadata_ReminderFrequency)(0),                                                                                 // 20: WABotMetadata.BotReminderMetadata.ReminderFrequency
	(BotReminderMetadata_ReminderAction)(0),                                                                                    // 21: WABotMetadata.BotReminderMetadata.ReminderAction
	(BotSignatureVerificationUseCaseProof_BotSignatureUseCase)(0),                                                              // 22: WABotMetadata.BotSignatureVerificationUseCaseProof.BotSignatureUseCase
	(BotSourcesMetadata_BotSourceItem_SourceProvider)(0),                                                                       // 23: WABotMetadata.BotSourcesMetadata.BotSourceItem.SourceProvider
	(*AIThreadInfo)(nil),                                         // 24: WABotMetadata.AIThreadInfo
	(*BotAgeCollectionMetadata)(nil),                             // 25: WABotMetadata.BotAgeCollectionMetadata
	(*BotAvatarMetadata)(nil),                                    // 26: WABotMetadata.BotAvatarMetadata
	(*BotCapabilityMetadata)(nil),                                // 27: WABotMetadata.BotCapabilityMetadata
	(*BotImagineMetadata)(nil),                                   // 28: WABotMetadata.BotImagineMetadata
	(*BotLinkedAccount)(nil),                                     // 29: WABotMetadata.BotLinkedAccount
	(*BotLinkedAccountsMetadata)(nil),                            // 30: WABotMetadata.BotLinkedAccountsMetadata
	(*BotMediaMetadata)(nil),                                     // 31: WABotMetadata.BotMediaMetadata
	(*BotMemoryFact)(nil),                                        // 32: WABotMetadata.BotMemoryFact
	(*BotMemoryMetadata)(nil),                                    // 33: WABotMetadata.BotMemoryMetadata
	(*BotMemuMetadata)(nil),                                      // 34: WABotMetadata.BotMemuMetadata
	(*BotMessageOrigin)(nil),                                     // 35: WABotMetadata.BotMessageOrigin
	(*BotMessageOriginMetadata)(nil),                             // 36: WABotMetadata.BotMessageOriginMetadata
	(*BotMetadata)(nil),                                          // 37: WABotMetadata.BotMetadata
	(*BotMetricsMetadata)(nil),                                   // 38: WABotMetadata.BotMetricsMetadata
	(*BotModeSelectionMetadata)(nil),                             // 39: WABotMetadata.BotModeSelectionMetadata
	(*BotModelMetadata)(nil),                                     // 40: WABotMetadata.BotModelMetadata
	(*BotPluginMetadata)(nil),                                    // 41: WABotMetadata.BotPluginMetadata
	(*BotProgressIndicatorMetadata)(nil),                         // 42: WABotMetadata.BotProgressIndicatorMetadata
	(*BotPromotionMessageMetadata)(nil),                          // 43: WABotMetadata.BotPromotionMessageMetadata
	(*BotPromptSuggestion)(nil),                                  // 44: WABotMetadata.BotPromptSuggestion
	(*BotPromptSuggestions)(nil),                                 // 45: WABotMetadata.BotPromptSuggestions
	(*BotQuotaMetadata)(nil),                                     // 46: WABotMetadata.BotQuotaMetadata
	(*BotReminderMetadata)(nil),                                  // 47: WABotMetadata.BotReminderMetadata
	(*BotRenderingMetadata)(nil),                                 // 48: WABotMetadata.BotRenderingMetadata
	(*BotSessionMetadata)(nil),                                   // 49: WABotMetadata.BotSessionMetadata
	(*BotSignatureVerificationMetadata)(nil),                     // 50: WABotMetadata.BotSignatureVerificationMetadata
	(*BotSignatureVerificationUseCaseProof)(nil),                 // 51: WABotMetadata.BotSignatureVerificationUseCaseProof
	(*BotSourcesMetadata)(nil),                                   // 52: WABotMetadata.BotSourcesMetadata
	(*BotSuggestedPromptMetadata)(nil),                           // 53: WABotMetadata.BotSuggestedPromptMetadata
	(*BotUnifiedResponseMutation)(nil),                           // 54: WABotMetadata.BotUnifiedResponseMutation
	(*InThreadSurveyMetadata)(nil),                               // 55: WABotMetadata.InThreadSurveyMetadata
	(*AIThreadInfo_AIThreadClientInfo)(nil),                      // 56: WABotMetadata.AIThreadInfo.AIThreadClientInfo
	(*AIThreadInfo_AIThreadServerInfo)(nil),                      // 57: WABotMetadata.AIThreadInfo.AIThreadServerInfo
	(*BotProgressIndicatorMetadata_BotPlanningStepMetadata)(nil), // 58: WABotMetadata.BotProgressIndicatorMetadata.BotPlanningStepMetadata
	(*BotProgressIndicatorMetadata_BotPlanningStepMetadata_BotPlanningSearchSourcesMetadata)(nil), // 59: WABotMetadata.BotProgressIndicatorMetadata.BotPlanningStepMetadata.BotPlanningSearchSourcesMetadata
	(*BotProgressIndicatorMetadata_BotPlanningStepMetadata_BotPlanningStepSectionMetadata)(nil),   // 60: WABotMetadata.BotProgressIndicatorMetadata.BotPlanningStepMetadata.BotPlanningStepSectionMetadata
	(*BotProgressIndicatorMetadata_BotPlanningStepMetadata_BotPlanningSearchSourceMetadata)(nil),  // 61: WABotMetadata.BotProgressIndicatorMetadata.BotPlanningStepMetadata.BotPlanningSearchSourceMetadata
	(*BotQuotaMetadata_BotFeatureQuotaMetadata)(nil),                                              // 62: WABotMetadata.BotQuotaMetadata.BotFeatureQuotaMetadata
	(*BotRenderingMetadata_Keyword)(nil),                                                          // 63: WABotMetadata.BotRenderingMetadata.Keyword
	(*BotSignatureVerificationUseCaseProof_CertificateSKI)(nil),                                   // 64: WABotMetadata.BotSignatureVerificationUseCaseProof.CertificateSKI
	(*BotSourcesMetadata_BotSourceItem)(nil),                                                      // 65: WABotMetadata.BotSourcesMetadata.BotSourceItem
	...
	(*InThreadSurveyMetadata_InThreadSurveyPrivacyStatementPart)(nil),                             // 68: WABotMetadata.InThreadSurveyMetadata.InThreadSurveyPrivacyStatementPart
	(*InThreadSurveyMetadata_InThreadSurveyOption)(nil),                                           // 69: WABotMetadata.InThreadSurveyMetadata.InThreadSurveyOption
	(*InThreadSurveyMetadata_InThreadSurveyQuestion)(nil),                                         // 70: WABotMetadata.InThreadSurveyMetadata.InThreadSurveyQuestion
	(*waAICommon.AIRegenerateMetadata)(nil),                                                       // 71: WAWebProtobufsAICommon.AIRegenerateMetadata
	(*waAICommon.SessionTransparencyMetadata)(nil),                                                // 72: WAWebProtobufsAICommon.SessionTransparencyMetadata
	(*waAICommon.BotDocumentMessageMetadata)(nil),                                                 // 73: WAWebProtobufsAICommon.BotDocumentMessageMetadata
	(*waAICommon.BotGroupMetadata)(nil),                                                           // 74: WAWebProtobufsAICommon.BotGroupMetadata
	(*waAICommon.BotRenderingConfigMetadata)(nil),                                                 // 75: WAWebProtobufsAICommon.BotRenderingConfigMetadata
	(*waAICommon.BotInfrastructureDiagnostics)(nil),                                               // 76: WAWebProtobufsAICommon.BotInfrastructureDiagnostics
	(*waAICommon.AIMediaCollectionMetadata)(nil),                                                  // 77: WAWebProtobufsAICommon.AIMediaCollectionMetadata
	(*waAICommon.BotCommandMetadata)(nil),                                                         // 78: WAWebProtobufsAICommon.BotCommandMetadata
	(*waAICommon.BotResolvedToolCallMetadata)(nil),                                                // 79: WAWebProtobufsAICommon.BotResolvedToolCallMetadata
	(*waAICommon.AISubscriptionUpsellMetadata)(nil),                                               // 80: WAWebProtobufsAICommon.AISubscriptionUpsellMetadata
	(*waAICommon.BotPttPromptMetadata)(nil),                                                       // 81: WAWebProtobufsAICommon.BotPttPromptMetadata
	(*waAICommon.BotHistoryShareMetadata)(nil),                                                    // 82: WAWebProtobufsAICommon.BotHistoryShareMetadata
	(*waCommon.MessageKey)(nil),                                                                   // 83: WACommon.MessageKey
}
var file_waBotMetadata_WABotMetadata_proto_depIdxs = []int32{
	57, // 0: WABotMetadata.AIThreadInfo.serverInfo:type_name -> WABotMetadata.AIThreadInfo.AIThreadServerInfo
	56, // 1: WABotMetadata.AIThreadInfo.clientInfo:type_name -> WABotMetadata.AIThreadInfo.AIThreadClientInfo
	4,  // 2: WABotMetadata.BotAgeCollectionMetadata.ageCollectionType:type_name -> WABotMetadata.BotAgeCollectionMetadata.AgeCollectionType
	5,  // 3: WABotMetadata.BotCapabilityMetadata.capabilities:type_name -> WABotMetadata.BotCapabilityMetadata.BotCapabilityType
	6,  // 4: WABotMetadata.BotImagineMetadata.imagineType:type_name -> WABotMetadata.BotImagineMetadata.ImagineType
	7,  // 5: WABotMetadata.BotLinkedAccount.type:type_name -> WABotMetadata.BotLinkedAccount.BotLinkedAccountType
	29, // 6: WABotMetadata.BotLinkedAccountsMetadata.accounts:type_name -> WABotMetadata.BotLinkedAccount
	8,  // 7: WABotMetadata.BotMediaMetadata.orientationType:type_name -> WABotMetadata.BotMediaMetadata.OrientationType
	32, // 8: WABotMetadata.BotMemoryMetadata.addedFacts:type_name -> WABotMetadata.BotMemoryFact
	32, // 9: WABotMetadata.BotMemoryMetadata.removedFacts:type_name -> WABotMetadata.BotMemoryFact
	31, // 10: WABotMetadata.BotMemuMetadata.faceImages:type_name -> WABotMetadata.BotMediaMetadata
	9,  // 11: WABotMetadata.BotMessageOrigin.type:type_name -> WABotMetadata.BotMessageOrigin.BotMessageOriginType
	35, // 12: WABotMetadata.BotMessageOriginMetadata.origins:type_name -> WABotMetadata.BotMessageOrigin
	26, // 13: WABotMetadata.BotMetadata.avatarMetadata:type_name -> WABotMetadata.BotAvatarMetadata
	41, // 14: WABotMetadata.BotMetadata.pluginMetadata:type_name -> WABotMetadata.BotPluginMetadata
	53, // 15: WABotMetadata.BotMetadata.suggestedPromptMetadata:type_name -> WABotMetadata.BotSuggestedPromptMetadata
	49, // 16: WABotMetadata.BotMetadata.sessionMetadata:type_name -> WABotMetadata.BotSessionMetadata
	34, // 17: WABotMetadata.BotMetadata.memuMetadata:type_name -> WABotMetadata.BotMemuMetadata
	47, // 18: WABotMetadata.BotMetadata.reminderMetadata:type_name -> WABotMetadata.BotReminderMetadata
	40, // 19: WABotMetadata.BotMetadata.modelMetadata:type_name -> WABotMetadata.BotModelMetadata
	42, // 20: WABotMetadata.BotMetadata.progressIndicatorMetadata:type_name -> WABotMetadata.BotProgressIndicatorMetadata
	27, // 21: WABotMetadata.BotMetadata.capabilityMetadata:type_name -> WABotMetadata.BotCapabilityMetadata
	28, // 22: WABotMetadata.BotMetadata.imagineMetadata:type_name -> WABotMetadata.BotImagineMetadata
	33, // 23: WABotMetadata.BotMetadata.memoryMetadata:type_name -> WABotMetadata.BotMemoryMetadata
	48, // 24: WABotMetadata.BotMetadata.renderingMetadata:type_name -> WABotMetadata.BotRenderingMetadata
	38, // 25: WABotMetadata.BotMetadata.botMetricsMetadata:type_name -> WABotMetadata.BotMetricsMetadata
	30, // 26: WABotMetadata.BotMetadata.botLinkedAccountsMetadata:type_name -> WABotMetadata.BotLinkedAccountsMetadata
	52, // 27: WABotMetadata.BotMetadata.richResponseSourcesMetadata:type_name -> WABotMetadata.BotSourcesMetadata
	43, // 28: WABotMetadata.BotMetadata.botPromotionMessageMetadata:type_name -> WABotMetadata.BotPromotionMessageMetadata
	39, // 29: WABotMetadata.BotMetadata.botModeSelectionMetadata:type_name -> WABotMetadata.BotModeSelectionMetadata
	46, // 30: WABotMetadata.BotMetadata.botQuotaMetadata:type_name -> WABotMetadata.BotQuotaMetadata
	25, // 31: WABotMetadata.BotMetadata.botAgeCollectionMetadata:type_name -> WABotMetadata.BotAgeCollectionMetadata
	50, // 32: WABotMetadata.BotMetadata.verificationMetadata:type_name -> WABotMetadata.BotSignatureVerificationMetadata
	54, // 33: WABotMetadata.BotMetadata.unifiedResponseMutation:type_name -> WABotMetadata.BotUnifiedResponseMutation
	36, // 34: WABotMetadata.BotMetadata.botMessageOriginMetadata:type_name -> WABotMetadata.BotMessageOriginMetadata
	55, // 35: WABotMetadata.BotMetadata.inThreadSurveyMetadata:type_name -> WABotMetadata.InThreadSurveyMetadata
	24, // 36: WABotMetadata.BotMetadata.botThreadInfo:type_name -> WABotMetadata.AIThreadInfo
	71, // 37: WABotMetadata.BotMetadata.regenerateMetadata:type_name -> WAWebProtobufsAICommon.AIRegenerateMetadata
	72, // 38: WABotMetadata.BotMetadata.sessionTransparencyMetadata:type_name -> WAWebProtobufsAICommon.SessionTransparencyMetadata
	73, // 39: WABotMetadata.BotMetadata.botDocumentMessageMetadata:type_name -> WAWebProtobufsAICommon.BotDocumentMessageMetadata
	74, // 40: WABotMetadata.BotMetadata.botGroupMetadata:type_name -> WAWebProtobufsAICommon.BotGroupMetadata
	75, // 41: WABotMetadata.BotMetadata.botRenderingConfigMetadata:type_name -> WAWebProtobufsAICommon.BotRenderingConfigMetadata
	76, // 42: WABotMetadata.BotMetadata.botInfrastructureDiagnostics:type_name -> WAWebProtobufsAICommon.BotInfrastructureDiagnostics
	77, // 43: WABotMetadata.BotMetadata.aiMediaCollectionMetadata:type_name -> WAWebProtobufsAICommon.AIMediaCollectionMetadata
	78, // 44: WABotMetadata.BotMetadata.commandMetadata:type_name -> WAWebProtobufsAICommon.BotCommandMetadata
	79, // 45: WABotMetadata.BotMetadata.resolvedToolCallMetadata:type_name -> WAWebProtobufsAICommon.BotResolvedToolCallMetadata
	80, // 46: WABotMetadata.BotMetadata.subscriptionUpsellMetadata:type_name -> WAWebProtobufsAICommon.AISubscriptionUpsellMetadata
	81, // 47: WABotMetadata.BotMetadata.pttPromptMetadata:type_name -> WAWebProtobufsAICommon.BotPttPromptMetadata
	82, // 48: WABotMetadata.BotMetadata.botHistoryShareMetadata:type_name -> WAWebProtobufsAICommon.BotHistoryShareMetadata
	0,  // 49: WABotMetadata.BotMetricsMetadata.destinationEntryPoint:type_name -> WABotMetadata.BotMetricsEntryPoint
	1,  // 50: WABotMetadata.BotMetricsMetadata.threadOrigin:type_name -> WABotMetadata.BotMetricsThreadEntryPoint
	10, // 51: WABotMetadata.BotModeSelectionMetadata.mode:type_name -> WABotMetadata.BotModeSelectionMetadata.BotUserSelectionMode
	12, // 52: WABotMetadata.BotModelMetadata.modelType:type_name -> WABotMetadata.BotModelMetadata.ModelType
	11, // 53: WABotMetadata.BotModelMetadata.premiumModelStatus:type_name -> WABotMetadata.BotModelMetadata.PremiumModelStatus
	14, // 54: WABotMetadata.BotPluginMetadata.provider:type_name -> WABotMetadata.BotPluginMetadata.SearchProvider
	13, // 55: WABotMetadata.BotPluginMetadata.pluginType:type_name -> WABotMetadata.BotPluginMetadata.PluginType
	83, // 56: WABotMetadata.BotPluginMetadata.parentPluginMessageKey:type_name -> WACommon.MessageKey
	13, // 57: WABotMetadata.BotPluginMetadata.deprecatedField:type_name -> WABotMetadata.BotPluginMetadata.PluginType
	13, // 58: WABotMetadata.BotPluginMetadata.parentPluginType:type_name -> WABotMetadata.BotPluginMetadata.PluginType
	58, // 59: WABotMetadata.BotProgressIndicatorMetadata.stepsMetadata:type_name -> WABotMetadata.BotProgressIndicatorMetadata.BotPlanningStepMetadata
	18, // 60: WABotMetadata.BotPromotionMessageMetadata.promotionType:type_name -> WABotMetadata.BotPromotionMessageMetadata.BotPromotionType
	44, // 61: WABotMetadata.BotPromptSuggestions.suggestions:type_name -> WABotMetadata.BotPromptSuggestion
	62, // 62: WABotMetadata.BotQuotaMetadata.botFeatureQuotaMetadata:type_name -> WABotMetadata.BotQuotaMetadata.BotFeatureQuotaMetadata
	83, // 63: WABotMetadata.BotReminderMetadata.requestMessageKey:type_name -> WACommon.MessageKey
	21, // 64: WABotMetadata.BotReminderMetadata.action:type_name -> WABotMetadata.BotReminderMetadata.ReminderAction
	20, // 65: WABotMetadata.BotReminderMetadata.frequency:type_name -> WABotMetadata.BotReminderMetadata.ReminderFrequency
	63, // 66: WABotMetadata.BotRenderingMetadata.keywords:type_name -> WABotMetadata.BotRenderingMetadata.Keyword
	2,  // 67: WABotMetadata.BotSessionMetadata.sessionSource:type_name -> WABotMetadata.BotSessionSource
	51, // 68: WABotMetadata.BotSignatureVerificationMetadata.proofs:type_name -> WABotMetadata.BotSignatureVerificationUseCaseProof
	22, // 69: WABotMetadata.BotSignatureVerificationUseCaseProof.useCase:type_name -> WABotMetadata.BotSignatureVerificationUseCaseProof.BotSignatureUseCase
	64, // 70: WABotMetadata.BotSignatureVerificationUseCaseProof.certificateChainSki:type_name -> WABotMetadata.BotSignatureVerificationUseCaseProof.CertificateSKI
	65, // 71: WABotMetadata.BotSourcesMetadata.sources:type_name -> WABotMetadata.BotSourcesMetadata.BotSourceItem
	45, // 72: WABotMetadata.BotSuggestedPromptMetadata.promptSuggestions:type_name -> WABotMetadata.BotPromptSuggestions
	67, // 73: WABotMetadata.BotUnifiedResponseMutation.sbsMetadata:type_name -> WABotMetadata.BotUnifiedResponseMutation.SideBySideMetadata
	66, // 74: WABotMetadata.BotUnifiedResponseMutation.mediaDetailsMetadataList:type_name -> WABotMetadata.BotUnifiedResponseMutation.MediaDetailsMetadata
	70, // 75: WABotMetadata.InThreadSurveyMetadata.questions:type_name -> WABotMetadata.InThreadSurveyMetadata.InThreadSurveyQuestion
	68, // 76: WABotMetadata.InThreadSurveyMetadata.privacyStatementParts:type_name -> WABotMetadata.InThreadSurveyMetadata.InThreadSurveyPrivacyStatementPart
	3,  // 77: WABotMetadata.AIThreadInfo.AIThreadClientInfo.type:type_name -> WABotMetadata.AIThreadInfo.AIThreadClientInfo.AIThreadType
	59, // 78: WABotMetadata.BotProgressIndicatorMetadata.BotPlanningStepMetadata.sourcesMetadata:type_name -> WABotMetadata.BotProgressIndicatorMetadata.BotPlanningStepMetadata.BotPlanningSearchSourcesMetadata
	16, // 79: WABotMetadata.BotProgressIndicatorMetadata.BotPlanningStepMetadata.status:type_name -> WABotMetadata.BotProgressIndicatorMetadata.BotPlanningStepMetadata.PlanningStepStatus
	60, // 80: WABotMetadata.BotProgressIndicatorMetadata.BotPlanningStepMetadata.sections:type_name -> WABotMetadata.BotProgressIndicatorMetadata.BotPlanningStepMetadata.BotPlanningStepSectionMetadata
	17, // 81: WABotMetadata.BotProgressIndicatorMetadata.BotPlanningStepMetadata.BotPlanningSearchSourcesMetadata.provider:type_name -> WABotMetadata.BotProgressIndicatorMetadata.BotPlanningStepMetadata.BotPlanningSearchSourcesMetadata.BotPlanningSearchSourceProvider
	61, // 82: WABotMetadata.BotProgressIndicatorMetadata.BotPlanningStepMetadata.BotPlanningStepSectionMetadata.sourcesMetadata:type_name -> WABotMetadata.BotProgressIndicatorMetadata.BotPlanningStepMetadata.BotPlanningSearchSourceMetadata
	15, // 83: WABotMetadata.BotProgressIndicatorMetadata.BotPlanningStepMetadata.BotPlanningSearchSourceMetadata.provider:type_name -> WABotMetadata.BotProgressIndicatorMetadata.BotPlanningStepMetadata.BotSearchSourceProvider
	19, // 84: WABotMetadata.BotQuotaMetadata.BotFeatureQuotaMetadata.featureType:type_name -> WABotMetadata.BotQuotaMetadata.BotFeatureQuotaMetadata.BotFeatureType
	22, // 85: WABotMetadata.BotSignatureVerificationUseCaseProof.CertificateSKI.useCase:type_name -> WABotMetadata.BotSignatureVerificationUseCaseProof.BotSignatureUseCase
	23, // 86: WABotMetadata.BotSourcesMetadata.BotSourceItem.provider:type_name -> WABotMetadata.BotSourcesMetadata.BotSourceItem.SourceProvider
	31, // 87: WABotMetadata.BotUnifiedResponseMutation.MediaDetailsMetadata.highResMedia:type_name -> WABotMetadata.BotMediaMetadata
	31, // 88: WABotMetadata.BotUnifiedResponseMutation.MediaDetailsMetadata.previewMedia:type_name -> WABotMetadata.BotMediaMetadata
	69, // 89: WABotMetadata.InThreadSurveyMetadata.InThreadSurveyQuestion.questionOptions:type_name -> WABotMetadata.InThreadSurveyMetadata.InThreadSurveyOption
